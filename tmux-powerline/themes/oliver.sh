...
TMUX_POWERLINE_DEFAULT_BACKGROUND_COLOR=${TMUX_POWERLINE_DEFAULT_BACKGROUND_COLOR:-'#3c3836'} # this is the whole bar color
TMUX_POWERLINE_DEFAULT_FOREGROUND_COLOR=${TMUX_POWERLINE_DEFAULT_FOREGROUND_COLOR:-'#a89984'} # this is the background for the window status
...
if [ -z "$TMUX_POWERLINE_LEFT_STATUS_SEGMENTS" ]; then
	TMUX_POWERLINE_LEFT_STATUS_SEGMENTS=(
		"tmux_session_info ${GRUV_CYAN} ${GRUV_GRAY1}"
		#"mode_indicator 165 0"
		#"ifstat 30 255"
		#"ifstat_sys 30 255"
		# "lan_ip 24 255 ${TMUX_POWERLINE_SEPARATOR_RIGHT_THIN}"
		# "pwd #d65d0e ${GRUV_GRAY1}"
...
if [ -z "$TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS" ]; then
	TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS=(
		...
		# "xkb_layout 125 117"
		"date_day ${GRUV_CYAN} ${GRUV_GRAY1}"
		"date ${GRUV_CYAN}  ${GRUV_GRAY1} ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN}"
		"time ${GRUV_CYAN} ${GRUV_GRAY1} ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN}"
		"utc_time ${GRUV_CYAN} ${GRUV_GRAY1} ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN}"
	)
fi
